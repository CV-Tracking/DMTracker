...
class Tracker:
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        # for frame_num, frame_path in enumerate(zip(seq.frames[1:], seq.depth_frames[1:]), start=1):
            ...
            # ptb_size = [out['target_bbox'][0], out['target_bbox'][1], out['target_bbox'][0]+out['target_bbox'][2],out['target_bbox'][1]+out['target_bbox'][3]]
            # out_ = {'target_bbox':ptb_size, 'confidence':out['confidence']}
            _store_outputs(out, {'time': time.time() - start_time})
            # _store_outputs(out_, {'time': time.time() - start_time})
