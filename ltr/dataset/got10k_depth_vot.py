...
class Got10k_depth(BaseVideoDataset):
    ...
    def _load_meta_info(self):
        sequence_meta_info = {s: self._read_meta(os.path.join(self.root, s, 'color')) for s in self.sequence_list}
    ...
    def _read_target_visible(self, seq_path):
        ...
        occlusion_file = os.path.join(seq_path, 'color',"absence.label")
        cover_file = os.path.join(seq_path, 'color',"cover.label")
