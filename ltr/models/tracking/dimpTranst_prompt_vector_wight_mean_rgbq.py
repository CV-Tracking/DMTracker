...
class DiMPnet_DeT(nn.Module):
    ...
    def fusion(self, color_feat, depth_feat):
        ...
        fusionfeat_layer2 = color_feat['layer2'].tensors + self.fuse_weight_layer2 * fusionfeat_layer2

        # fusionfeat_layer2 = torch.cat((color_feat['layer2'].tensors, fusionfeat_layer2),dim=1)
        fusionfeat_layer2 = self.rgb_weight * fusionfeat_layer2 + self.depth_weight * depth_feat['layer2'].tensors
        ...
        fusionfeat_layer3 = color_feat['layer3'].tensors + self.fuse_weight_layer3 * fusionfeat_layer3

        # fusionfeat_layer3 = torch.cat((color_feat['layer3'].tensors, fusionfeat_layer3),dim=1)
        fusionfeat_layer3 = self.rgb_weight * fusionfeat_layer3 + self.depth_weight * depth_feat['layer3'].tensors
