...
class DiMPnet_DeT(nn.Module):
    ...
    def forward(self, train_imgs, test_imgs, train_bb, test_proposals, *args, **kwargs):
        ...
        train_feat = self.extract_backbone_features(train_imgs.reshape(-1, *train_imgs.shape[-3:])) #torch.Size([3, 10, 6, 288, 288])-->torch.Size([30, 6, 288, 288]) {'layer2': tensor([[[[1.4271e-0...Backward>), 'layer3': tensor([[[[3.1881e-0...Backward>)}
