...
class DiMPnet_DMT(nn.Module):
    ...
    #     #test SPM
    #     fusionfeat_layer2 = color_feat['layer2'].tensors +  depth_feat['layer2'].tensors
    #    # fusionfeat_layer2 = depth_feat['layer2'].tensors +  fusionfeat_layer2
    #     fusionfeat_layer2 = self.rgb_weight * color_feat['layer2'].tensors + self.depth_weight * fusionfeat_layer2


    #     fusionfeat_layer3 = color_feat['layer3'].tensors +  depth_feat['layer3'].tensors
...
def dimp50_DeT(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
    ...
    # DMT network
    net = DiMPnet_DMT(feature_extractor=backbone_net, feature_extractor_depth=backbone_net_depth, classifier=classifier, bb_regressor=bb_regressor,
